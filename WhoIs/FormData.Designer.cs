...
namespace WhoIs
{
    partial class FormData
    {
        ...
        private void InitializeComponent()
        {
			...
			this.usersGrid1 = new WhoIs.Controls.UsersGrid();
			...
			this.panelControlsFormData.SuspendLayout();
			...
			// 
			this.panelControlsFormData.Controls.Add(this.usersGrid1);
			...
			// usersGrid1
			// 
			this.usersGrid1.Location = new System.Drawing.Point(0, 0);
			this.usersGrid1.Name = "usersGrid1";
			this.usersGrid1.Size = new System.Drawing.Size(684, 465);
			...
			this.panelControlsFormData.ResumeLayout(false);
		...
		private Controls.UsersGrid usersGrid1;
	}
}